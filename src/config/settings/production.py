"""
Production settings for anthologies project.
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['.anthologies.co', ])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default='anthologies <reply-to-a-human@anthologies.co>')
EMAIL_SUBJECT_PREFIX = env(
    'DJANGO_EMAIL_SUBJECT_PREFIX', default='[anthologies.co]')
